...
export const IMAGE_PLACEHOLDER = 'https://placehold.co/300x450/1a1a2e/ffffff?text=No+Image';
...
export const PRICE_DROP_PER_YEAR = 1.0;

export const DEFAULT_USERNAME = 'User';

export const DEFAULT_MOVIE_GENRES = MOVIE_GENRES.map((g) => g.value);
export const DEFAULT_TV_GENRES = TV_GENRES.map((g) => g.value);
